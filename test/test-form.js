...
exports['nested fields'] = function (test) {
    ...
    f.bind({
        ...
        test.equals(
            ...
            '<div class="field"><label for="id_outer.inner.double_nested_array">Double nested_array</label><input type="text" name="outer[inner][double_nested_array]" id="id_outer.inner.double_nested_array" value="bar,baz" /></div>'
        );
        test.done();
    });
};
